<template>
  <div v-if="showModal" class="fixed inset-0 z-50 overflow-auto bg-smoke-dark flex select-none">
    <div
      ...
      <form @submit.prevent="submit">
        <div>
          ...
          <div class="q-pa-md">
            <q-carousel arrows animated v-model="slide" height="200px" class="img">
